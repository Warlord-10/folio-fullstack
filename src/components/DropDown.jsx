  ...
  return (
    <div className='text-sm font-thin'>
        <div className='flex items-center gap-2 cursor-pointer'>
            ...
            <div onClick={()=>folderFunctions.setFolderId(repoId)} className='flex items-center gap-2 cursor-pointer'>
        ...
        <div className={visible?'flex flex-col pl-2.5 items-start gap-1':'hidden'}>
            ...
            {repoData.files && repoData.files.map((file, key) => (
                <div className='flex items-center gap-2 cursor-pointer' onClick={()=>fileFunctions.setFileId(file._id)} key={key}>
