        ...
        <div className='flex flex-col h-full bg-gradient-to-t from-zinc-950 to-neutral-900 rounded-lg shadow-lg'>
            <div className='relative p-2'>
                ...
                <img
                    ...
                    src={userData.avatar_path ? requests.publicFiles(userData.avatar_path) : "https://devforum-uploads.s3.dualstack.us-east-2.amazonaws.com/uploads/original/4X/a/9/4/a940fe649d1d5bb4355b3dc5ccdee540bb7d2929.png"}
                    alt={userData.name}
                />
            </div>
            <div className='p-6 flex flex-col gap-6'>
                ...
                <p className='text-gray-300 border-y-2 py-4'>{userData.about}</p>
