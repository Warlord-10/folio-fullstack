    ...
    return (
        <div className='flex flex-col p-3 max-w-[400px]'>
            {isUserEdit
                ...
                : <>
                    {/* <div className='max-w-[400px] border-2 border-gray-600 aspect-square flex justify-center items-center rounded-full'>
                    </div> */}
                    <img
                        className='max-w-[400px] aspect-square rounded-full border-2 border-gray-600'
