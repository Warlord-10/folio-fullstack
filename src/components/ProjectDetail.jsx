                ...
                {isDeleting === 'file' && 
                    <PopUpBox toClose={setIsDeleting} customStyle={{height: 'fit-content'}} heading={'Confirm Delete?'}>
                        <div className='flex flex-col items-center justify-center px-4'>
                            <p className='text-gray-300'>Are you sure you want to delete <span className='text-red-600'>{fileData.name}</span> ?</p>
                            <button className='bg-red-600 text-white p-2 m-4 rounded-md hover:bg-red-700 transition duration-200 w-2/4' onClick={() => {(e) => e.preventDefault(); fileFunctions.deleteFile(fileData._id); setIsDeleting(false)}}>Yes</button>
                        </div>
                    </PopUpBox>
                }
            </div>
        ...
        return (
            <div className='flex p-3 hover:bg-gray-800 justify-between items-center rounded-lg transition duration-300' key={key}>
                ...
                {isDeleting === 'folder' && 
                    <PopUpBox toClose={setIsDeleting} customStyle={{height: 'fit-content'}} heading={'Confirm Delete?'}>
                        <div className='flex flex-col items-center justify-center px-4'>
                            <p className='text-gray-300'>Are you sure you want to delete <span className='text-red-600'>{folderData.name}</span> ?</p>
                            <button className='bg-red-600 text-white p-2 m-4 rounded-md hover:bg-red-700 transition duration-200 w-2/4' onClick={() => {(e) => e.preventDefault(); folderFunctions.deleteFolder(folderData._id); setIsDeleting(false)}}>Yes</button>
                        </div>
                    </PopUpBox>
                }
            </div>
