...
function Page2() {
  return (
    <div className='page-2 bg-black font-[Anta] text-[25rem] overflow-clip'>
        ...
        {/* <div className='page page-2-card-1 font-[Anta] text-[25rem] bg-black p-5'>
        ...
        <div className='page page-2-card-2 sticky top-0 bg-black justify-center items-center flex'>
          <p className='text-reveal text-center text-white text-[8rem] font-mono p-10'>
            <span>
        ...
        <div className='h-[100vh] page-2-card-3 flex sticky top-0'>
